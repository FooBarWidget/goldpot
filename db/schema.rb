...
ActiveRecord::Schema.define(:version => 20110822122760) do
  ...
  create_table "transactions", :force => true do |t|
    ...
    t.index ["folder_id"], :name => "index_transactions_on_folder_id"
    t.foreign_key ["folder_id"], "folders", ["id"], :on_update => :cascade, :on_delete => :cascade
